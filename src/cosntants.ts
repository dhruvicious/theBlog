...
export const BLOG_TITLE: string = "Dhruv Writes";
export const BLOG_DESC: string =
  "Deep technical explorations in C++, embedded systems, and parallel computing, featuring weekly reproducible experiments and performance insights.";
